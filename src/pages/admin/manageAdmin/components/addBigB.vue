  ...
  <div class="adminList">
    ...
    <div class="detailBox">
      ...
      >
        ...
        <div class="buttonBox">
             <el-button type="primary" @click="submitForm('addBigBForm')">创建</el-button>
            <el-button @click="resetForm('addBigBForm')">取消</el-button>
        </div>
      </el-form>
    </div>
  </div>
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        areas: [
          { required: true, message: "！请选择公司所在地区", trigger: "blur" }
        ],
        phone:[
